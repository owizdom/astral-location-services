...
import { keccak256, toUtf8Bytes, verifyMessage, recoverAddress } from 'ethers';
import type { LocationStamp, LocationClaim, StampVerificationResult } from '../../../types/verify.js';
